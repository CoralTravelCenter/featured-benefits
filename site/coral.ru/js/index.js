...
ASAP(function() {
  ...
  $('.cover .buttonlike').on('click', function() {
    return $(this).closest('.feature-comp').addClass('open');
  });
  $(window).on('mousedown touchstart', function(e) {
    if (!$(e.target).closest('.feature-comp.open').length) {
      return $('.feature-comp.open').removeClass('open');
    }
  });
